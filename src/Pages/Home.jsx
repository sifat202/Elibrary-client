...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-base-100 overflow-x-hidden">
      ...
      <div 
        className="mt-4 mb-10 mx-auto max-w-5xl overflow-hidden pointer-events-none [mask-image:linear-gradient(to_right,transparent,white_20%,white_80%,transparent)]"
        data-aos="fade-up"
        data-aos-delay="400"
      >
